...
export default function CambioContra({ setEmail }) {
          ...
          <MDBCol col="12" cl>
            ...
            >
              <MDBCardBody className="p-5 d-flex flex-column align-items-center mx-auto w-100">
                ...
                <p className="">Por favor ingrese su nueva contraseña</p>
                ...
                <p className="">Por favor verifique su contraseña</p>
                ...
                <div className="text-center">
                  <p className="mb-0">
                    Desea Volver Atrás?{" "}
                    <a href="/profile" className="text-white fw-bold text-2xl hover:bg-sky-700 no-underline rounded-md">
                      <br />
                      Regresar
                    </a>
                  </p>
